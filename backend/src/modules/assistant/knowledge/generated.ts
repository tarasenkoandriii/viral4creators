...
export const ASSISTANT_KNOWLEDGE_BUILT_AT = '2026-09-16T03:10:34.419Z';
...
export const ASSISTANT_STEPS: Record<string, AssistantStepItem[]> = {
  ru: [
    ...
    {
      title: 'Выберите формат и картинки для Veo',
    ...
    },
    {
      ...
      text: 'Google Veo 3.1 рендерит новое рекламное видео — на выбор быстрое или более кинематографичное качество рендера.',
      details: [
        'Фото товара обязательно — без него кнопка генерации не появится',
        'Кнопка «Сгенерировать рекламный ролик»',
        'При неудаче — «Сгенерировать ещё раз»',
    ...
    },
    {
      ...
      text: 'Отдельная вкладка «Постпрод» — все ваши готовые ролики, а не только последний. Смените текст реплик и голос — с явным выбором провайдера синтеза и честной пред-прослушкой до оплаты — без нового рендера у Veo. Экспортируйте под несколько площадок и опубликуйте со страницей для шеринга.',
      details: [
        'Переозвучка без нового рендера у Veo — меняются звук, субтитры и текст реплик (Standard+)',
        'Провайдер синтеза голоса — явно ElevenLabs или Resemble, либо «как сейчас»',
        'Пред-прослушать точную комбинацию текста, голоса и провайдера — до оплаты переозвучки',
  ...
  uk: [
    ...
    {
      title: 'Оберіть формат і зображення для Veo',
    ...
    },
    {
      ...
      text: 'Google Veo 3.1 рендерить нове рекламне відео — на вибір швидка або більш кінематографічна якість рендеру.',
      details: [
        'Фото товару обов’язкове — без нього кнопка генерації не з’явиться',
        'Кнопка «Згенерувати рекламний ролик»',
        'У разі невдачі — «Згенерувати ще раз»',
    ...
    },
    {
      ...
      text: 'Окрема вкладка «Постпрод» — усі ваші готові ролики, а не лише останній. Змініть текст реплік і голос — з явним вибором провайдера синтезу та чесним попереднім прослуховуванням до оплати — без нового рендеру у Veo. Експортуйте під кілька площадок і опублікуйте зі сторінкою для шерингу.',
      details: [
        'Переозвучка без нового рендеру у Veo — змінюються звук, субтитри і текст реплік (Standard+)',
        'Провайдер синтезу голосу — явно ElevenLabs або Resemble, або «як зараз»',
        'Попередньо прослухати точну комбінацію тексту, голосу і провайдера — до оплати переозвучки',
  ...
  en: [
    ...
    {
      title: 'Choose the format and images for Veo',
    ...
    },
    {
      ...
      text: 'Google Veo 3.1 renders the new ad video — pick fast or more cinematic render quality.',
      details: [
        'A product photo is required — the generate button stays hidden without it',
        '"Generate the ad video" button',
        'On failure — "Generate again"',
    ...
    },
    {
      ...
      text: 'A separate Postprod tab with all your finished videos, not just the latest one. Change the script and the voice — with an explicit synthesis provider and an honest pre-listen before you pay — without a new Veo render. Export to several platforms and publish with a shareable page.',
      details: [
        'Re-voice without a new Veo render — only the audio, subtitles and script change (Standard+)',
        'Voice synthesis provider — ElevenLabs or Resemble explicitly, or “as is”',
        'Pre-listen to the exact text, voice and provider combination — before paying for the re-voice',
  ...
  de: [
    ...
    {
      title: 'Format und Bilder für Veo wählen',
    ...
    },
    {
      ...
      text: 'Google Veo 3.1 rendert das neue Werbevideo — wahlweise in schneller oder kinematografischerer Render-Qualität.',
      details: [
        'Ein Produktfoto ist Pflicht — ohne es erscheint der Generieren-Button nicht',
        'Schaltfläche „Werbevideo generieren"',
        'Bei Fehlschlag — „Erneut generieren"',
  ...
  es: [
    ...
    {
      title: 'Elige el formato y las imágenes para Veo',
    ...
    },
    {
      ...
      text: 'Google Veo 3.1 renderiza el nuevo video publicitario — a elección, calidad rápida o más cinematográfica.',
      details: [
        'La foto del producto es obligatoria — sin ella el botón de generar no aparece',
        'Botón «Generar video publicitario»',
        'Si falla — «Generar de nuevo»',
    ...
    },
    {
      ...
      text: 'Una pestaña aparte, «Postprod», con todos tus videos terminados, no solo el último. Cambia el texto y la voz — con un proveedor de síntesis explícito y una escucha previa honesta antes de pagar — sin un nuevo renderizado en Veo. Exporta a varias plataformas y publica con una página para compartir.',
      details: [
        'Redoblaje sin nuevo renderizado en Veo — solo cambian el audio, los subtítulos y el texto (Standard+)',
        'Proveedor de síntesis de voz — ElevenLabs o Resemble de forma explícita, o «como está»',
        'Escucha previa de la combinación exacta de texto, voz y proveedor — antes de pagar el redoblaje',
