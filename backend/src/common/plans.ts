 ...
 *    В будущем станет условно-бесплатным лестницей: регистрация даёт
 *    одну генерацию, подписка на канал проекта (YouTube или Telegram)
 *    — вторую, каждое подтверждённое приглашение — ещё одну, седьмое
 *    снимает ограничение навсегда. Единица — генерация провайдером и
 *    качеством ПО УМОЛЧАНИЮ (сегодня Grok 480p): у бесплатной
 *    генерации выбора качества нет, иначе один клик в 1080p утраивает
 *    стоимость награды. Засчитывается приглашённый, который
 *    сам дошёл до готового ролика
 *    (`docs-tz/TZ-Uslovno-Besplatnyi-Lite.md`). Важно для ЭТОГО файла:
 *    граница бесплатного НЕ станет четвёртым режимом — она отвечает на
 *    вопрос «можно ли сейчас потратить наши деньги», а матрица ниже —
 *    на вопрос «какие функции открыты». Смешивать их нельзя: тогда
 *    придётся решать, что рисовать под замком тому, у кого функция
 *    открыта, а генерация закрыта;
