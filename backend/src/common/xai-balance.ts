...
import { BalanceUnits } from './unit-balance';
...
export interface ProviderBalance {
   ...
   * символа зависит от тарифа и меняется, и посчитанная нами сумма
   * разошлась бы со счётом провайдера без всякого способа это
   * заметить.
   */
  units?: BalanceUnits;
