          ...
          return (
            <li id={`step-${n}`} className="step-card" key={step.title}>
              ...
              {variant === 'full' && hasDetails && (
                // Шаг 9 — единственный со сворачиваемым списком (§3.3
                // ТЗ, семь опциональных панелей результата не помещаются
                // без сворачивания); остальные восемь показывают список
                // сразу, 2-4 пункта не загромождают карточку.
                n === 9 ? (
                  <details>
