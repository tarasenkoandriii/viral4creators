...
/**
 * Имя файла иконки выводится из ПОРЯДКОВОГО НОМЕРА шага, а не из его
 * содержания (находка 1.4 аудита поздравлений).
 *
 * Это осознанное ограничение, а не недосмотр: компонент рассчитан на
 * один набор шагов — пайплайн генерации рекламного ролика, — и файлы
 * `how-step-1…10` нарисованы именно под него. Любой ДРУГОЙ набор шагов,
 * переданный сюда, молча получит чужие иконки: «загрузите товар»,
 * «выберите референс», «ИИ разбирает ролик». Поэтому страница
 * поздравлений (этап 3) свои четыре шага рисует сама, а не зовёт этот
 * компонент. Если наборов когда-нибудь станет два по-настоящему — сюда
 * нужен проп с префиксом имён, а не ещё один вызов как есть.
 */
