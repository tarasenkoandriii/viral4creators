 ...
 *
 * `how-step-10` добавлен этапом 92 (десятый шаг обучалки — раздел
 * «Постпродакшн», TMA-навигация выросла с 3 до 4 вкладок) тем же
 * line-art стилем, что и `how-step-1`…`how-step-9`.
 */
