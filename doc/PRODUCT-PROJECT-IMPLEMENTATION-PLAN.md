...
- Backend: **219 маршрутов в 46 контроллерах** (214/44 после этапа 82 —
  ...
  валидна); все **107** миграций подряд на чистом Postgres 16
  ...
  **5008 тестов / 320 наборов** (2051/145 после аудита кода трёх
  ...
  Frontend: tsc, eslint 0, vite build, **41** unit-скрипт
