...
- Backend: **219 маршрутов в 46 контроллерах** (214/44 после этапа 82 —
  ...
  валидна); все **89** миграций подряд на чистом Postgres 16
  ...
  **4314 тестов / 277 наборов** (2051/145 после аудита кода трёх
  ...
  Frontend: tsc, eslint 0, vite build, **34** unit-скрипта
