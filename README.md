...
`doc/API.md` is the current, complete route list (358 routes in 66 controller files; CI checks the count). The older
...
a hand-written migration drifting from the schema, types, lint, 3789
tests with per-file coverage thresholds), frontend (types, lint, 27 unit
