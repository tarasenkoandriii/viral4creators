...
`doc/API.md` is the current, complete route list (185 routes in 39 controller files; CI checks the count). The older
...
a hand-written migration drifting from the schema, types, lint, 2051
