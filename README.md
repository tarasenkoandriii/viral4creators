...
`doc/API.md` is the current, complete route list (359 routes in 66 controller files; CI checks the count). The older
...
a hand-written migration drifting from the schema, types, lint, 3846
