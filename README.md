...
`doc/API.md` is the current, complete route list (247 routes in 51 controller files; CI checks the count). The older
...
tests with per-file coverage thresholds), frontend (types, lint, 20 unit
