...
`doc/API.md` is the current, complete route list (429 routes in 77 controller files; CI checks the count). The older
...
a hand-written migration drifting from the schema, types, lint, 5104
tests with per-file coverage thresholds), frontend (types, lint, 43 unit
